...
<html lang="en">
    ...
    <body>
        ...
        <header 
            ...
            ="main_menu home_menu upperHead">
            <%if (!request.getParameter("vista").equals("true")) {%>
            <div class  
                    ...
                    <div class  
                        ...
                        <nav class  
                            ...
                            <div class  
                                 ...
                                 ="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                                <ul class  
                                    ...
                                    <li class  
                                        ...
                                        <a class  
                                           ...
                                           ="nav-link" href="index.jsp">Inicio</a>
                                    </li>
                                    <li class  
                                        ...
                                        <a class  
                                           ...
                                           ="nav-link" href="Nosotros.html">Nosotros</a>
                                    </li>
                                    <li class  
                                        ...
                                        <a class  
                                           ...
                                           ="nav-link" href="USUARIO_ListarActividades.jsp">Actividades</a>
                                    </li>
                                    <li class  
                                        ...
                                        <a class  
                                           ...
                                           ="nav-link" href="Galeria.html">Galería</a>
                                    </li>
                                    <li class  
                                        ...
                                        <a class  
                                           ...
                                           ="nav-link" href="contact.html">Contáctenos</a>
                                    </li>
                                </ul>
                            </div
        ...
        <a class="col-10 mx-4 my-2 btn btn_2" href="EMPRESA_Actividades.jsp">Volver</a>
        <%}%>
        </header>
