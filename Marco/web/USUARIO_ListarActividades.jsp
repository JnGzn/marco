                    ...
                    <div class="progress-table-wrap col-12" id="inicio">
                        <div class="progress-table col-12">
                            ...
                            <div class="table-row col-12">
                                ...
                                <div class=" col-2 mx-auto"> <a href="USUARIO_VerActividad.jsp?actividad=<%=  actVo.getId()%>&vista=<%=actVo.getId()%>" >Ver mas</a></div>
                            </div>
                            </div>
                            <%}%>
                        </div>
...
//                                String zona = request.getParameter("");                          
                            ...
                            <div class="table-row col-12">
                                ...
                                <div class=" col-2">  <%=   actVo.getCupos()%></div>
                                <div class=" col-3 mx-auto" > <img src="<%=   actVo.getImage1()%>" width="70%" height="90"> </div>
                                <div class=" col-2 mx-auto"> <a href="USUARIO_VerActividad.jsp?actividad=<%=  actVo.getId()%>" >Ver mas</a></div>
